...
<body>
    ...
    <section>
        <!-- Tipos de usuarios -->
        <div class="col-md-12" style="margin-top: 200px; text-align: center; margin-bottom: 50px">
            <div style="max-width: 600px; margin: 0 auto;" class="cuadrosombra">
                <h2>Tipos de personal</h2>
                <p>Total de personal registrado: <?php echo($contUsuarios) ?></p>
...
<script>
        ...
        const contAlumnos = <?= $contAlumnos ?>;
        const contProfesores = <?= $contProfesores ?>;
        const contAdmins = <?= $contAdmins ?>;
        const contUsuarios = <?= $contUsuarios ?>;
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [contAlumnos, contProfesores, contAdmins],
                        backgroundColor: [
                            'rgba(75, 192, 192, 0.7)',
                            'rgba(255, 159, 64, 0.7)',
