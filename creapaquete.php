            ...
            <div class="row justify-content-center" style="padding: 0px">
                <div class="col-md-6">
                    <div style="margin-top: 25px; margin-bottom: 25px" class="cuadrosombra">
                        ...
                        <form id="creaPaquete" action="validapaquete.php" method="POST">

                            <!-- Formulario para rellenar los datos del paquete, el programa ya comprueba que no puedas poner una fecha de FIN anterior a la de INICIO -->
                            <!-- Además una vez establecido precio y cantidad de clases, no podrá modificarse mas tarde para evitar perjudicar a los alumnos -->
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="descripcion" id="descripcion" form="creaPaquete" rows="5" required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="cantClases" name="cantClases" min="1" required>
                            </div>
