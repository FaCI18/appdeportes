...
<body>
    ...
    <section id="about" class="">
		<!-- =============== container =============== -->
        <div class="container" style="margin-left: 168px; margin-right: 15px">            
            <div class="row" style="padding: 0px">
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInDown animated" data-wow-delay=".5s" style="padding: 50px">
                   <h2>¿Tienes dudas o sugerencias?</h2>
				    <p>En nuestra escuela valoramos la opinión de nuestros estudiantes, padres y comunidad. Si tienes alguna duda, sugerencia o comentario, no dudes en ponerte en contacto con nosotros. ¡Estamos aquí para ayudarte y mejorar continuamente! Puedes encontrarnos directamente en nuestras instalaciones o escribirnos directamente al correo [mariana.deportes@example.com].</p>   
                </div>
