...
include 'sesion.php';
    ...
    # Extrae de la base de datos la lista de las horas que nosotros asignamos para las clases para que podamos 
    ...
    #al usar el fetch_assoc lo que hacemos es que recorre todos los resultados que la query nos arroje asi hasta ya no tener mas resultados
    while($row = $result_horas->fetch_assoc()) {
        $horas[$row['id_horario']]=$row['hora'];
    }

    # Extraer lista profesores
    $sql_profesores = "SELECT * FROM usuarios WHERE rol=2";
    $result_profesores = $conn->query($sql_profesores);

    $profesores = [];
    while($row = $result_profesores->fetch_assoc()) {
        $profesores[$row['id_usuario']]=$row['nombre']." ".$row['apellido_paterno']." ".$row['apellido_materno'];
    }
?>
<!DOCTYPE html>
<!--
            ...
            <div class="row justify-content-center" style="padding: 0px">
                <div class="col-md-6">
                    <div style="margin-top: 25px; margin-bottom: 25px" class="cuadrosombra">
                        <h1 style="margin-top: 5px">Creando clase</h1>
                        <!-- aqui empieza el formulario para crear clases-->
                        <form id="creaClase" action="validaclase.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <br>
                                <textarea name="descripcion" id="descripcion" form="creaClase" rows="5" required></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <!--recorremos la lista de horas y creamos un boton por cada hora, en este caso un deplegable en el que
                                 se muestran las horas posibles que ya hemos asiganado en la base de datos-->
                                <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="cupos" name="cupos" min="1" max="100" required>
                            </div>
                            <div class="form-group">
                                <label for="precio">Precio ( $ )</label>
                                <input type="number" value="100" class="form-control" id="precio" name="precio" min="1" disabled>
                            </div>
                            <div class="form-group">
                                ...
                                <!--recorremos la lista de profesores y creamos un boton por cada profesor, en este caso una lista  en el que
                                 se muestran los profesores posibles que ya tenemos registrados en la base de datos-->
                                <?php
